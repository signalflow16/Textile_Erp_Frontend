...
import type { FrappeDocumentPayload, FrappeListPayload, MasterDataRequestState } from "@/modules/stock/types/master-data";
import type { FrappeMessageResponse } from "@/core/api/frappeTypes";
